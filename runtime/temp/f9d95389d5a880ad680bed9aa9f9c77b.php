        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" >
                <input type="text" id="job_name" name="job_name" required="" lay-verify="required"
                       autocomplete="off" class="layui-input"  style="width: 200%;" value="<?php echo !empty($data['job_name'])?$data['job_name']:''; ?>">
            </div>
        </div>

        <div class="layui-form-item">
            <label for="username" class="layui-form-label" >
                <span class="x-red">*</span>岗位名称[英文]
            </label>
            <div class="layui-input-inline" >
                <input type="text" id="en_job_name" name="en_job_name" required="" lay-verify="required"
                       autocomplete="off" class="layui-input"  style="width: 200%;" value="<?php echo !empty($data['en_job_name'])?$data['en_job_name']:''; ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" >
                <input type="text" id="job_address" name="job_address" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="<?php echo !empty($data['job_address'])?$data['job_address']:''; ?>">
            </div>
        </div>

        <div class="layui-form-item">
            <label for="username" class="layui-form-label" >
                <span class="x-red">*</span>工作地点[英文]
            </label>
            <div class="layui-input-inline" >
                <input type="text" id="en_job_address" name="en_job_address" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="<?php echo !empty($data['en_job_address'])?$data['en_job_address']:''; ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" >
                <input type="text" id="branch" name="branch" required="" lay-verify="required"
                       autocomplete="off" class="layui-input"  value="<?php echo !empty($data['branch'])?$data['branch']:''; ?>">
            </div>
        </div>

        <div class="layui-form-item">
            <label for="username" class="layui-form-label" >
                <span class="x-red">*</span>部门[英文]
            </label>
            <div class="layui-input-inline" >
                <input type="text" id="en_branch" name="en_branch" required="" lay-verify="required"
                       autocomplete="off" class="layui-input"  value="<?php echo !empty($data['en_branch'])?$data['en_branch']:''; ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="work_years" name="work_years" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" style="width: 200%;" value="<?php echo !empty($data['work_years'])?$data['work_years']:''; ?>">
            </div>
        </div>

        <div class="layui-form-item">
            <label for="username" class="layui-form-label">
                <span class="x-red">*</span> 工作年限[英文]
            </label>

            <div class="layui-input-inline">
                <input type="text" id="en_work_years" name="en_work_years" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" style="width: 200%;" value="<?php echo !empty($data['en_work_years'])?$data['en_work_years']:''; ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="education" name="education" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" style="width: 200%;" value="<?php echo !empty($data['education'])?$data['education']:''; ?>" >
            </div>
        </div>

        <div class="layui-form-item">
            <label for="username" class="layui-form-label">
                <span class="x-red">*</span> 学历要求[英文]
            </label>

            <div class="layui-input-inline">
                <input type="text" id="en_education" name="en_education" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" style="width: 200%;" value="<?php echo !empty($data['en_education'])?$data['en_education']:''; ?>" >
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" id="job_num" name="job_num" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="<?php echo !empty($data['job_num'])?$data['job_num']:''; ?>">
            </div>
        </div>
...
<script>
    ...
    layui.use(['laydate','form','layer','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            $.ajax({
                url:'<?php echo url("admin/job/edit_go"); ?>',
                type:'POST',
                data:{"data":dataArr},
