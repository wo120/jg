<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\phpstudy\WWW\changcheng\public/../application/admin\view\job\lists.html";i:1546847002;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
        ...
        <form class="layui-form layui-col-md12 x-so">
            <div class="layui-input-inline">
                <select name="time">
                    ...
                    <option value="<?php echo $t['start_time']; ?>"><?php echo $t['start_time']; ?></option>
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td><?php echo $v['job_address']; ?></td>
            <td><?php echo $v['branch']; ?></td>
            <td><?php echo $v['start_time']; ?></td>
            <td><?php echo $v['work_years']; ?></td>
            <td><?php echo $v['education']; ?></td>
            <td><?php echo $v['job_num']; ?></td>
            <td class="td-manage">
                <!--<a title="查看投递的简历"  onclick='x_admin_show("查看","<?php echo url('admin/job/show'); ?>?id=<?php echo $v['id']; ?>")' href="javascript:;">-->
                <!--<i class="layui-icon">&#xe63c;</i>-->
                <!--</a>-->
                <a title="编辑"  onclick='x_admin_show("编辑","<?php echo url('admin/job/edit'); ?>?id=<?php echo $v['id']; ?>")' href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
                </a>
...
<script>
    ...
    function job_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                url:'<?php echo url("admin/job/del"); ?>',
                type:'POST',
                data:{"id":id},
    ...
    function delAll (argument) {
        ...
        layer.confirm('确认要删除吗？'+data,function(index){
            ...
            console.log(data);
            $.ajax({
                url:'<?php echo url("admin/job/dels"); ?>',
                type:'POST',
                data:{"ids":data},
                success:function(data){
                    console.log(data);
