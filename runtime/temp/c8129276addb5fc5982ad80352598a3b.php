...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick='x_admin_show("添加媒体报导","<?php echo url('admin/news/mt_add'); ?>")'><i class="layui-icon"></i>添加</button>
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-manage">
                ...
                <a title="编辑"  onclick='x_admin_show("编辑","<?php echo url('admin/news/mt_edit'); ?>?id=<?php echo $v['id']; ?>")' href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" onclick="mt_news_del(this,'<?php echo $v['id']; ?>')" href="javascript:;">
                    <i class="layui-icon">&#xe640;</i>
                </a>
            </td>
        </tr>
...
<script>
    ...
    /*用户-删除*/
    function mt_news_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据

            $.ajax({
                url:'<?php echo url("admin/news/mt_news_del"); ?>',
                type:'POST',
                data:{"id":id},
    ...
    function delAll (argument) {
        ...
        layer.confirm('确认要删除吗？'+data,function(index){
            ...
            console.log(data);
            $.ajax({
                url:'<?php echo url("admin/news/mt_dels"); ?>',
                type:'POST',
                data:{"ids":data},
                success:function(data){
                    console.log(data);
